...
This skill exists to ensure that guide is followed and to catch the common gap: developers (and Codex) shipping a change that touches gated code without thinking through both modes.
